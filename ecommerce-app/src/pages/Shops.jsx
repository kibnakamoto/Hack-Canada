...
import { Store, ArrowRight, Loader2, MapPin, Star } from 'lucide-react';
          ...
          <div className="grid grid-cols-4" style={{ gap: '2rem' }}>
            {shops.map(shop => (
              <div key={shop.vendorId} className="glass shop-card" style={{ 
                ...
                <button className="btn btn-secondary" style={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}>
